...
<div className="bg-black min-h-screen flex flex-col items-center">
  ...
  {/* Dropdown Menu */}
  <div className="relative  group pt-8 z-50 w-full flex items-center justify-center px-6">
  ...
  <div className="flex flex-col items-center w-full px-4">
    ...
    <button
      ...
      <div>
        <h1 className="text-green-500">Note : if any model does not work than use another model </h1>
      </div>
      </div>
    </div>
  </div>
  ...
  <div className="flex items-center justify-center gap-4 pb-10 mt-4">
    ...
    >
      ...
      <div class="lshadow absolute w-[30%] h-[25%] bg-pink-500 top-[-15%] left-[-10%] rounded-[50%] blur-[150px]"></div>
      <div class="lshadow absolute w-[20%] h-[40%] bg-green-500 top-[45%] left-[-15%] rounded-[50%] blur-[150px]"></div>
<div class="rshadow absolute w-[20%] h-[40%] bg-violet-500 top-[80%] right-[-10%] rounded-[50%] blur-[150px]"></div>
<div class="rshadow absolute w-[20%] h-[40%] bg-blue-500 top-[15%] right-[-15%] rounded-[50%] blur-[150px]"></div>
